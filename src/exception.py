...
def get_error_detail(error_messages,error_detail:sys):
    ...
    error_message= "Error occured in file named {0}, at line number {1} - error {3}".format(file_name, exc_tb.tb_lineno,error_messages)
...
class CustomException(Exception):
    ...
    def __init__(error_message, error_detail:sys):
